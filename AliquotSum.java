/* In this program I'm trying to show the Aliquot sum of perfect numbers by using Has-A relationship 
*/
package assignment8; //here I have created package 
...
public class AliquotSum {  //taken the main class
		...
		// here i have taken  main method
			public static void main(String[] args) {
				...
				int number = 25;  // here i have take an integer type of variable to check weather it is perfect number or not 
